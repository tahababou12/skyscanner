    ...
    <footer className="bg-gray-100 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">CityScanner</h3>
            <p className="text-gray-600 text-sm">
              Find the best way to get around your city with our comprehensive intracity travel comparison platform.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-gray-600 text-sm">© 2023 CityScanner. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
